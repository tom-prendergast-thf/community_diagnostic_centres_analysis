...
View(Q3flagged2agg_filtered)  



# make sure week data is a categorical variable 

Q3flagged2agg_filtered$Week_Range <- factor(Q3flagged2agg_filtered$Week_Range,  
                                            
                                            levels = c("sum_i.00 < 01 Week", "sum_i.01 < 02 Weeks", "sum_i.02 < 03 Weeks","sum_i.03 < 04 Weeks", "sum_i.04 < 05 Weeks", "sum_i.05 < 06 Weeks", "sum_i.06 < 07 Weeks", "sum_i.07 < 08 Weeks", "sum_i.08 < 09 Weeks", "sum_i.09 < 10 Weeks", "sum_i.10 < 11 Weeks", "sum_i.11 < 12 Weeks", "sum_i.12 < 13 Weeks", "sum_i.13+ Weeks"))  

# remove TOTAL columns - rows 393 to 420 

Q3flagged2agg_filtered <- Q3flagged2agg_filtered[-c(393:420), ] 



#split into two dfs - one for 0 values one for 1 values 
...
Q3flagged2agg_filtered_flag_0 <- Q3flagged2agg_filtered %>% 
  
  filter(flag == 0) 

Q3flagged2agg_filtered_flag_1 <- Q3flagged2agg_filtered %>% 
